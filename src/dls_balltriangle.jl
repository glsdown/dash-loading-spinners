...
export dls_balltriangle

"""
    dls_balltriangle(;kwargs...)
    dls_balltriangle(children::Any;kwargs...)
    dls_balltriangle(children_maker::Function;kwargs...)
...
"""
function dls_balltriangle(; kwargs...)
        available_props = Symbol[:children, :id, :color, :debounce, :fullscreen, :fullscreenClassName, :fullscreen_style, :height, :radius, :show_initially, :speedMultiplier, :width]
        wild_props = Symbol[]
        return Component("dls_balltriangle", "BallTriangle", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_balltriangle(children::Any; kwargs...) = dls_balltriangle(;kwargs..., children = children)
dls_balltriangle(children_maker::Function; kwargs...) = dls_balltriangle(children_maker(); kwargs...)
