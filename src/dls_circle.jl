...
"""
    dls_circle(;kwargs...)
    dls_circle(children::Any;kwargs...)
    dls_circle(children_maker::Function;kwargs...)
...
function dls_circle(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_circle", "Circle", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_circle(children::Any; kwargs...) = dls_circle(;kwargs..., children = children)
dls_circle(children_maker::Function; kwargs...) = dls_circle(children_maker(); kwargs...)
