...
"""
    dls_rspacman(;kwargs...)
    dls_rspacman(children::Any;kwargs...)
    dls_rspacman(children_maker::Function;kwargs...)


A RSPacman component.
...
function dls_rspacman(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rspacman", "RSPacman", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rspacman(children::Any; kwargs...) = dls_rspacman(;kwargs..., children = children)
dls_rspacman(children_maker::Function; kwargs...) = dls_rspacman(children_maker(); kwargs...)
