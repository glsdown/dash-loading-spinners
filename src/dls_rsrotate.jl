...
"""
    dls_rsrotate(;kwargs...)
    dls_rsrotate(children::Any;kwargs...)
    dls_rsrotate(children_maker::Function;kwargs...)


A RSRotate component.
...
function dls_rsrotate(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rsrotate", "RSRotate", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rsrotate(children::Any; kwargs...) = dls_rsrotate(;kwargs..., children = children)
dls_rsrotate(children_maker::Function; kwargs...) = dls_rsrotate(children_maker(); kwargs...)
