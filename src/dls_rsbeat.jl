...
"""
    dls_rsbeat(;kwargs...)
    dls_rsbeat(children::Any;kwargs...)
    dls_rsbeat(children_maker::Function;kwargs...)
...
function dls_rsbeat(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rsbeat", "RSBeat", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rsbeat(children::Any; kwargs...) = dls_rsbeat(;kwargs..., children = children)
dls_rsbeat(children_maker::Function; kwargs...) = dls_rsbeat(children_maker(); kwargs...)
