...
export dls_rsclimbingbox

"""
    dls_rsclimbingbox(;kwargs...)
    dls_rsclimbingbox(children::Any;kwargs...)
    dls_rsclimbingbox(children_maker::Function;kwargs...)
...
"""
function dls_rsclimbingbox(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rsclimbingbox", "RSClimbingBox", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rsclimbingbox(children::Any; kwargs...) = dls_rsclimbingbox(;kwargs..., children = children)
dls_rsclimbingbox(children_maker::Function; kwargs...) = dls_rsclimbingbox(children_maker(); kwargs...)
