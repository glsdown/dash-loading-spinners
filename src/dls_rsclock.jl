...
"""
    dls_rsclock(;kwargs...)
    dls_rsclock(children::Any;kwargs...)
    dls_rsclock(children_maker::Function;kwargs...)
...
function dls_rsclock(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rsclock", "RSClock", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rsclock(children::Any; kwargs...) = dls_rsclock(;kwargs..., children = children)
dls_rsclock(children_maker::Function; kwargs...) = dls_rsclock(children_maker(); kwargs...)
