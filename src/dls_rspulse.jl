...
"""
    dls_rspulse(;kwargs...)
    dls_rspulse(children::Any;kwargs...)
    dls_rspulse(children_maker::Function;kwargs...)
...
function dls_rspulse(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rspulse", "RSPulse", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rspulse(children::Any; kwargs...) = dls_rspulse(;kwargs..., children = children)
dls_rspulse(children_maker::Function; kwargs...) = dls_rspulse(children_maker(); kwargs...)
