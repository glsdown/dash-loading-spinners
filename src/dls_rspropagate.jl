...
export dls_rspropagate

"""
    dls_rspropagate(;kwargs...)
    dls_rspropagate(children::Any;kwargs...)
    dls_rspropagate(children_maker::Function;kwargs...)
...
"""
function dls_rspropagate(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rspropagate", "RSPropagate", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rspropagate(children::Any; kwargs...) = dls_rspropagate(;kwargs..., children = children)
dls_rspropagate(children_maker::Function; kwargs...) = dls_rspropagate(children_maker(); kwargs...)
