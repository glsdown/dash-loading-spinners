...
"""
    dls_rsbounce(;kwargs...)
    dls_rsbounce(children::Any;kwargs...)
    dls_rsbounce(children_maker::Function;kwargs...)
...
function dls_rsbounce(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rsbounce", "RSBounce", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rsbounce(children::Any; kwargs...) = dls_rsbounce(;kwargs..., children = children)
dls_rsbounce(children_maker::Function; kwargs...) = dls_rsbounce(children_maker(); kwargs...)
