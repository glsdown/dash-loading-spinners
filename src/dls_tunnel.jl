...
"""
    dls_tunnel(;kwargs...)
    dls_tunnel(children::Any;kwargs...)
    dls_tunnel(children_maker::Function;kwargs...)
...
function dls_tunnel(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_tunnel", "Tunnel", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_tunnel(children::Any; kwargs...) = dls_tunnel(;kwargs..., children = children)
dls_tunnel(children_maker::Function; kwargs...) = dls_tunnel(children_maker(); kwargs...)
