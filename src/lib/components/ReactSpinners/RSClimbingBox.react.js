...
RSClimbingBox._dashprivate_isLoadingComponent = true;

RSClimbingBox.defaultProps = {
    debounce: 0,
    show_initially: true,
    color: '#000000',
    speedMultiplier: 1,
