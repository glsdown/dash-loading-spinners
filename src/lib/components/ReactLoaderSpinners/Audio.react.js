                    ...
                    <rect width={`${thickness}`} height="25%" rx="3">
                        <animate
                            ...
                            values={`${Math.ceil(
                                ...
                                (height * 79) / original_height
                            )};${Math.ceil((height * 20) / original_height)}`}
                            calcMode="linear"
                    ...
                    >
                        <animate
                            ...
                            values={`${height};${Math.ceil(
                                ...
                                (height * 75) / original_height
                            )};${Math.ceil(
                                (height * 23) / original_height
                            )};${Math.ceil(
                                (height * 73) / original_height
                            )};${Math.ceil(
                                (height * 33) / original_height
                            )};${Math.ceil(
                                (height * 12) / original_height
                            )};${Math.ceil(
                                (height * 14) / original_height
                            )};${Math.ceil(
                                (height * 60) / original_height
                            )};${height}`}
                            calcMode="linear"
                            repeatCount="indefinite"
                        />
