...
"""
    dls_dot(;kwargs...)
    dls_dot(children::Any;kwargs...)
    dls_dot(children_maker::Function;kwargs...)
...
function dls_dot(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_dot", "Dot", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_dot(children::Any; kwargs...) = dls_dot(;kwargs..., children = children)
dls_dot(children_maker::Function; kwargs...) = dls_dot(children_maker(); kwargs...)
