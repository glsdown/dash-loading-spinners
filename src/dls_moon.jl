...
"""
    dls_moon(;kwargs...)
    dls_moon(children::Any;kwargs...)
    dls_moon(children_maker::Function;kwargs...)
...
function dls_moon(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_moon", "Moon", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_moon(children::Any; kwargs...) = dls_moon(;kwargs..., children = children)
dls_moon(children_maker::Function; kwargs...) = dls_moon(children_maker(); kwargs...)
