...
"""
    dls_pulse(;kwargs...)
    dls_pulse(children::Any;kwargs...)
    dls_pulse(children_maker::Function;kwargs...)
...
- `margin` (Real; optional): The gap size between the dots (in px)
...
function dls_pulse(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_pulse", "Pulse", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_pulse(children::Any; kwargs...) = dls_pulse(;kwargs..., children = children)
dls_pulse(children_maker::Function; kwargs...) = dls_pulse(children_maker(); kwargs...)
