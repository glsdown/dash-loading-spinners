...
"""
    dls_rsscale(;kwargs...)
    dls_rsscale(children::Any;kwargs...)
    dls_rsscale(children_maker::Function;kwargs...)
...
function dls_rsscale(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rsscale", "RSScale", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rsscale(children::Any; kwargs...) = dls_rsscale(;kwargs..., children = children)
dls_rsscale(children_maker::Function; kwargs...) = dls_rsscale(children_maker(); kwargs...)
