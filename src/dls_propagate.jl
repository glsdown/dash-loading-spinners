...
export dls_propagate

"""
    dls_propagate(;kwargs...)
    dls_propagate(children::Any;kwargs...)
    dls_propagate(children_maker::Function;kwargs...)
...
dls_propagate(children::Any; kwargs...) = dls_propagate(;kwargs..., children = children)
dls_propagate(children_maker::Function; kwargs...) = dls_propagate(children_maker(); kwargs...)
