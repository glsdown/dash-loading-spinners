...
"""
    dls_rsdot(;kwargs...)
    dls_rsdot(children::Any;kwargs...)
    dls_rsdot(children_maker::Function;kwargs...)
...
function dls_rsdot(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rsdot", "RSDot", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rsdot(children::Any; kwargs...) = dls_rsdot(;kwargs..., children = children)
dls_rsdot(children_maker::Function; kwargs...) = dls_rsdot(children_maker(); kwargs...)
