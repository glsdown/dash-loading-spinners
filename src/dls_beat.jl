...
- `coverClassName` (String; optional): CSS class names to apply to the container when fullscreen=False.
- `cover_style` (Dict; optional): Defines CSS styles for the container when fullscreen=False.
