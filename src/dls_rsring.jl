...
"""
    dls_rsring(;kwargs...)
    dls_rsring(children::Any;kwargs...)
    dls_rsring(children_maker::Function;kwargs...)
...
function dls_rsring(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rsring", "RSRing", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rsring(children::Any; kwargs...) = dls_rsring(;kwargs..., children = children)
dls_rsring(children_maker::Function; kwargs...) = dls_rsring(children_maker(); kwargs...)
