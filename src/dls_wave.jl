...
"""
    dls_wave(;kwargs...)
    dls_wave(children::Any;kwargs...)
    dls_wave(children_maker::Function;kwargs...)
...
- `thickness` (Real; optional): The line thickness of the bars
- `width` (Real; optional): The width of the spinner (in px).
"""
function dls_wave(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_wave", "Wave", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_wave(children::Any; kwargs...) = dls_wave(;kwargs..., children = children)
dls_wave(children_maker::Function; kwargs...) = dls_wave(children_maker(); kwargs...)
