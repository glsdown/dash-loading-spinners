...
"""
    dls_roller(;kwargs...)
    dls_roller(children::Any;kwargs...)
    dls_roller(children_maker::Function;kwargs...)
...
"""
function dls_roller(; kwargs...)
        available_props = Symbol[:children, :id, :color, :debounce, :fullscreen, :fullscreenClassName, :fullscreen_style, :show_initially, :width]
        wild_props = Symbol[]
        return Component("dls_roller", "Roller", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_roller(children::Any; kwargs...) = dls_roller(;kwargs..., children = children)
dls_roller(children_maker::Function; kwargs...) = dls_roller(children_maker(); kwargs...)
