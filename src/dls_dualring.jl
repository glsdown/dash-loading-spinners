...
"""
    dls_dualring(;kwargs...)
    dls_dualring(children::Any;kwargs...)
    dls_dualring(children_maker::Function;kwargs...)
...
dls_dualring(children::Any; kwargs...) = dls_dualring(;kwargs..., children = children)
dls_dualring(children_maker::Function; kwargs...) = dls_dualring(children_maker(); kwargs...)
