...
"""
    dls_rsfade(;kwargs...)
    dls_rsfade(children::Any;kwargs...)
    dls_rsfade(children_maker::Function;kwargs...)
...
function dls_rsfade(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rsfade", "RSFade", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rsfade(children::Any; kwargs...) = dls_rsfade(;kwargs..., children = children)
dls_rsfade(children_maker::Function; kwargs...) = dls_rsfade(children_maker(); kwargs...)
