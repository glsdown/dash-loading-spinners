...
"""
    dls_rsmoon(;kwargs...)
    dls_rsmoon(children::Any;kwargs...)
    dls_rsmoon(children_maker::Function;kwargs...)
...
function dls_rsmoon(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rsmoon", "RSMoon", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rsmoon(children::Any; kwargs...) = dls_rsmoon(;kwargs..., children = children)
dls_rsmoon(children_maker::Function; kwargs...) = dls_rsmoon(children_maker(); kwargs...)
