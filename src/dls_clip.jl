...
"""
    dls_clip(;kwargs...)
    dls_clip(children::Any;kwargs...)
    dls_clip(children_maker::Function;kwargs...)
...
function dls_clip(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_clip", "Clip", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_clip(children::Any; kwargs...) = dls_clip(;kwargs..., children = children)
dls_clip(children_maker::Function; kwargs...) = dls_clip(children_maker(); kwargs...)
