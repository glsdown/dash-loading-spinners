...
"""
    dls_ellipsis(;kwargs...)
    dls_ellipsis(children::Any;kwargs...)
    dls_ellipsis(children_maker::Function;kwargs...)
...
"""
function dls_ellipsis(; kwargs...)
        available_props = Symbol[:children, :id, :color, :debounce, :fullscreen, :fullscreenClassName, :fullscreen_style, :show_initially, :width]
        wild_props = Symbol[]
        return Component("dls_ellipsis", "Ellipsis", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_ellipsis(children::Any; kwargs...) = dls_ellipsis(;kwargs..., children = children)
dls_ellipsis(children_maker::Function; kwargs...) = dls_ellipsis(children_maker(); kwargs...)
