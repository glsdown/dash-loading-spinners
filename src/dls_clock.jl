...
"""
    dls_clock(;kwargs...)
    dls_clock(children::Any;kwargs...)
    dls_clock(children_maker::Function;kwargs...)
...
dls_clock(children::Any; kwargs...) = dls_clock(;kwargs..., children = children)
dls_clock(children_maker::Function; kwargs...) = dls_clock(children_maker(); kwargs...)
