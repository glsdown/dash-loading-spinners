...
function dls_revolvingdot(; kwargs...)
        available_props = Symbol[:children, :id, :color, :debounce, :fullscreen, :fullscreenClassName, :fullscreen_style, :radius, :secondaryColor, :show_initially, :speed_multiplier, :width]
        wild_props = Symbol[]
