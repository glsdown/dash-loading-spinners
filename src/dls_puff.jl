...
"""
    dls_puff(;kwargs...)
    dls_puff(children::Any;kwargs...)
    dls_puff(children_maker::Function;kwargs...)
...
function dls_puff(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_puff", "Puff", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_puff(children::Any; kwargs...) = dls_puff(;kwargs..., children = children)
dls_puff(children_maker::Function; kwargs...) = dls_puff(children_maker(); kwargs...)
