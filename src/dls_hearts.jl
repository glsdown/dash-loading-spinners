...
"""
    dls_hearts(;kwargs...)
    dls_hearts(children::Any;kwargs...)
    dls_hearts(children_maker::Function;kwargs...)
...
dls_hearts(children::Any; kwargs...) = dls_hearts(;kwargs..., children = children)
dls_hearts(children_maker::Function; kwargs...) = dls_hearts(children_maker(); kwargs...)
