...
"""
    dls_rscircle(;kwargs...)
    dls_rscircle(children::Any;kwargs...)
    dls_rscircle(children_maker::Function;kwargs...)
...
function dls_rscircle(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rscircle", "RSCircle", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rscircle(children::Any; kwargs...) = dls_rscircle(;kwargs..., children = children)
dls_rscircle(children_maker::Function; kwargs...) = dls_rscircle(children_maker(); kwargs...)
