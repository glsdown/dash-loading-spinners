...
"""
    dls_rsrise(;kwargs...)
    dls_rsrise(children::Any;kwargs...)
    dls_rsrise(children_maker::Function;kwargs...)
...
function dls_rsrise(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rsrise", "RSRise", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rsrise(children::Any; kwargs...) = dls_rsrise(;kwargs..., children = children)
dls_rsrise(children_maker::Function; kwargs...) = dls_rsrise(children_maker(); kwargs...)
