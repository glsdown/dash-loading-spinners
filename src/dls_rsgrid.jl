...
"""
    dls_rsgrid(;kwargs...)
    dls_rsgrid(children::Any;kwargs...)
    dls_rsgrid(children_maker::Function;kwargs...)
...
function dls_rsgrid(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rsgrid", "RSGrid", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rsgrid(children::Any; kwargs...) = dls_rsgrid(;kwargs..., children = children)
dls_rsgrid(children_maker::Function; kwargs...) = dls_rsgrid(children_maker(); kwargs...)
