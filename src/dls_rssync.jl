...
"""
    dls_rssync(;kwargs...)
    dls_rssync(children::Any;kwargs...)
    dls_rssync(children_maker::Function;kwargs...)
...
function dls_rssync(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rssync", "RSSync", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rssync(children::Any; kwargs...) = dls_rssync(;kwargs..., children = children)
dls_rssync(children_maker::Function; kwargs...) = dls_rssync(children_maker(); kwargs...)
