...
"""
    dls_rsclip(;kwargs...)
    dls_rsclip(children::Any;kwargs...)
    dls_rsclip(children_maker::Function;kwargs...)
...
function dls_rsclip(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rsclip", "RSClip", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rsclip(children::Any; kwargs...) = dls_rsclip(;kwargs..., children = children)
dls_rsclip(children_maker::Function; kwargs...) = dls_rsclip(children_maker(); kwargs...)
