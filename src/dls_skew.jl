...
"""
    dls_skew(;kwargs...)
    dls_skew(children::Any;kwargs...)
    dls_skew(children_maker::Function;kwargs...)
...
function dls_skew(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_skew", "Skew", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_skew(children::Any; kwargs...) = dls_skew(;kwargs..., children = children)
dls_skew(children_maker::Function; kwargs...) = dls_skew(children_maker(); kwargs...)
