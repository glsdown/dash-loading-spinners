...
"""
    dls_rise(;kwargs...)
    dls_rise(children::Any;kwargs...)
    dls_rise(children_maker::Function;kwargs...)
...
function dls_rise(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_rise", "Rise", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_rise(children::Any; kwargs...) = dls_rise(;kwargs..., children = children)
dls_rise(children_maker::Function; kwargs...) = dls_rise(children_maker(); kwargs...)
