...
"""
    dls_watch(;kwargs...)
    dls_watch(children::Any;kwargs...)
    dls_watch(children_maker::Function;kwargs...)
...
function dls_watch(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dls_watch", "Watch", "dash_loading_spinners", available_props, wild_props; kwargs...)
end

dls_watch(children::Any; kwargs...) = dls_watch(;kwargs..., children = children)
dls_watch(children_maker::Function; kwargs...) = dls_watch(children_maker(); kwargs...)
