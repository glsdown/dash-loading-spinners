...
dlsRSFade <- function(children=NULL, id=NULL, color=NULL, debounce=NULL, fullscreen=NULL, fullscreenClassName=NULL, fullscreen_style=NULL, height=NULL, margin=NULL, radius=NULL, show_initially=NULL, speedMultiplier=NULL, spinnerCSS=NULL, width=NULL) {
