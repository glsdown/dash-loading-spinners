...
dlsRotate <- function(children=NULL, id=NULL, color=NULL, debounce=NULL, fullscreen=NULL, fullscreenClassName=NULL, fullscreen_style=NULL, margin=NULL, show_initially=NULL, size=NULL, speedMultiplier=NULL, spinnerCSS=NULL) {
