...
dlsBallTriangle <- function(children=NULL, id=NULL, color=NULL, debounce=NULL, fullscreen=NULL, fullscreenClassName=NULL, fullscreen_style=NULL, height=NULL, radius=NULL, show_initially=NULL, speedMultiplier=NULL, width=NULL) {
